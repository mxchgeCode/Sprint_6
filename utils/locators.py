...
class YaScooterHomePageLocator:
    ...
    def faq_answer(answer_number):
        """
        Возвращает локатор дива с ответом FAQ (нумерация сверху вниз).
...
class YaScooterOrderPageLocator:
    ...
    INCORRECT_SUBWAY_MESSAGE = [By.XPATH,
                                ".//input[contains(@placeholder,'метро')]/"
                                "parent::div/parent::div/parent::div/div[@class!='select-search']"]
